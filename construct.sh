...
#SBATCH -o hparam.%N.%j.out
# Define a standard error file
#SBATCH -e hparam.%N.%j.err
...
python cif_zip_to_hdf5.py --cubic_supercell -s 500 -c cif_zip.zip -d cif_zip.csv -hd Data/ICSD.hdf5 -w 40
